...
export const AuthScreen: React.FC<AuthScreenProps> = ({ initialMode = "login", onAuthenticated }) => {
  ...
  const [form, setForm] = useState({ fullName: "", email: "", mobile: "", college: "", course: "BBA", year: "SY" as AcademicYear, password: "", confirmPassword: "", rememberMe: false });
    ...
    try {
      ...
      if (mode === "register") {
        ...
        setForm({
          ...
          college: "",
          course: "BBA",
          year: "SY" as AcademicYear,
          password: form.password,
          confirmPassword: "",
          rememberMe: false,
        });
        setNotice("Account created successfully. Please sign in with the same email and password.");
